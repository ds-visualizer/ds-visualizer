...
class Main {
  ...
  public static boolean balancedBrackets(String str) {
    ...
    Stack<Character> stack = new Stack<Character>();
      ...
      // toCharArray method is used for making the string into Character array.
        ...
        // If its an opening bracket, we won't get index -1 and we can push it into the
        ...
        // if its a close bracket we need to compare with opening bracket thats on top of the stack.
  ...
  // You could use a hash map instead of this but Since we didn't learn it yet, so I kept it simple
