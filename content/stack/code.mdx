...
> If you read till here, you question can we just use a linked list? cuz thats the same thing going around my mind now, there is no harm in using a linked list
