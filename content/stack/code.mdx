...
Instead of returning elements, you can use exception but Ill leave this friendly and not put any exceptions.
...
But the major difference is that, peek returns the element thats on the top of the stack, whereas pop removes the element on the top from the stack.
